...
public class Apart2 extends Residencial2 {
	...
	@Override
	/**
	 * @param quanto menor o valor de �ndice, melhor e mais f�cil ser� a venda ou aluguel do apartamento, a proporção é medida através da quantidade de cômodos em relação ao valor do aluguel ou venda. Ou seja, se o local tiver muitos quartos e o aluguel for baixo este será considerado mais fácil de alugar ou vender. 
	 */
	...
	/**
	 * 
	 * @param portaria == 1 -> H� portaria / portaria == 2 -> N�o h� portaria 
	 * @return
	 */
