...
public class Imovel {
	...
	/**
	 * @param status � iniciado apenas se os valores inseridos forem 1,2 ou 3. 
	 * 1 = status Ativo(o im�vel est� dispon�vel para venda ou loca��o)
	 * 2 = status Inativo(o im�vel foi retirado)
	 * 3 = status em Uso (o im�vel foi vendido ou alugado)
	 */
	...
	/**
	 * @param valor_aluguel apenas recebe o valor se o status for diferente de inativo(3), se o im�vel for para alugar e se o valor for maior que 0
	 */
	...
	/**
	 * @param valor_venda apenas recebe o valor se o status for diferente de inativo(3), se o im�vel for destinado � venda e se o valor for maior que 0
	 */
